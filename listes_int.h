 ...
 *
 * Les listes d'entiers sont codés dans une liste chaînée circulaire dont on connaît la tête et le pied.
...
/*!
 * Cette struture permet d'enregistrer une liste d'entiers. 
 ...
 * à la sortie de la fonction, pied pointe désormais sur ce nouvel élément (prendre en compte le cas de la liste vide).
 * \param l liste où insérer.
 * \param val valeur entière à insérer.
 */
...
/*! 
 * Suppression de l'élément avant courant s'il existe (tete et pied doivent être modifiés si nécessaire).
 * \param l liste d'où supprimer.
 */
...
/*! 
 * Suppression de l'élément apres courant s'il existe (tete et pied doivent être modifiés si nécessaire).
 * \param l liste d'où supprimer.
 */
